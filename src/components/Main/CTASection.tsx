        ...
        <div className="relative bg-[#F9F6F1] rounded-3xl p-8 md:p-14 shadow-[0_4px_24px_rgba(42,59,126,0.06)] border border-[#F0EBE0]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div>
              ...
              <h2 className="text-3xl md:text-5xl lg:text-6xl font-extrabold text-[#2A3B7E] leading-tight mb-6">
                Bring Precision to Your <br />
                <span className="text-[#EF7F44]">Next Campaign.</span>
              </h2>

              <p className="text-[#4A4A4A] text-base md:text-[21px] leading-relaxed mb-8 max-w-[80f0px]">
              ...
              <p className="font-bold text-[#EF7F44] text-xl md:text-2xl mb-3">
                Speak to Our Team
              </p>

              <a
                href="tel:+919876543210"
                className="inline-flex items-center gap-3 text-[#2A3B7E] font-extrabold text-xl md:text-2xl hover:text-[#EF7F44] transition-colors"
              >
            ...
            <div className="bg-[#2A3B7E] rounded-2xl p-8 md:p-10 text-white relative overflow-hidden">
              ...
              <a
                href="#"
                className="relative inline-flex items-center gap-2 bg-[#EF7F44] hover:bg-[#d96f36] transition-colors text-white font-semibold text-base md:text-lg px-6 py-3 rounded-full shadow-lg mb-8"
              >
                Start Your Campaign
